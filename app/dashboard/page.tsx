...
const statsData = [
  ...
  { label: "Nouvelles candidatures", value: "18", icon: Clock, color: "text-primary" },
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            <input
              ...
              className="h-10 w-64 rounded-lg border border-input bg-background px-4 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
            />
          </div>
        </div>
      </div>
